...
export const Navbar: React.FC = () => {
  ...
  const languages = [
    { code: 'kz', label: 'Қаз', flag: '🇰🇿', active: false },
    { code: 'ru', label: 'Рус', flag: '🇷🇺', active: true },
    { code: 'en', label: 'Eng', flag: '🇬🇧', active: false },
  ];
    ...
    <div className="absolute top-full right-0 mt-3 w-32 bg-[#1e293b] border border-slate-700/50 rounded-xl shadow-xl overflow-hidden py-1 z-50 animate-in fade-in zoom-in-95 duration-200">
      {languages.map((lang) => (
        <button
          ...
          className="w-full px-4 py-2.5 flex items-center gap-3 hover:bg-slate-800 transition-colors group"
        >
          <span className="text-lg leading-none">{lang.flag}</span>
          <span className={`text-sm font-medium ${lang.active ? 'text-red-500' : 'text-slate-300 group-hover:text-white'}`}>
            {lang.label}
          </span>
        </button>
      ))}
        ...
        <nav className="bg-slate-900/90 backdrop-blur-md border border-slate-800 rounded-3xl shadow-2xl pointer-events-auto transition-all duration-300">
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              ...
              {/* Desktop Links (Visible on Large screens and up) */}
              ...
              {/* Right Side Group: Phone, Globe, Menu */}
              <div className="flex items-center gap-3 md:gap-2 lg:gap-6">
                  {/* Phone Block: Tablet (md) and up */}
                  <div className="hidden md:flex items-center gap-4 lg:gap-6">
                      <div className="text-right">
                          ...
                          <div className="flex items-center justify-end gap-1.5 mt-0.5">
                              ...
                              <span className="text-[10px] text-slate-400 uppercase tracking-wide font-medium">Звоните, мы в сети</span>
                          </div>
                      </div>
                      
                      {/* Globe Icon - Visible on Tablet and Desktop */}
          ...
          >
            <div className="border-t border-slate-800">
              ...
              {/* Mobile Phone Block with Globe (Top Section - Full Width Border) */}
              {/* Hidden on tablet (md) and up because it's already in the header */}
              <div className="md:hidden px-4 sm:px-6 py-4 border-b border-slate-800 flex justify-between items-center">
                  <div>
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                            ...
                            <span className="text-[10px] text-slate-400 uppercase tracking-wide font-medium leading-none pt-[1px]">Звоните, мы в сети</span>
                      </div>
                  </div>
              ...
              {/* Links Section - Padding reverted to standard spacing */}
