...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="relative bg-slate-950 flex flex-col">
      ...
      {/* Hero Section - Screen Height on Desktop, Screen Height on Mobile too */}
      <div className="relative h-screen flex flex-col overflow-hidden">
        <div className="flex-1 flex items-center pt-24 md:pt-32 pb-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex flex-col justify-center">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center h-full">
              ...
              {/* Text Content - Always visible, centered on mobile h-screen */}
              <div className="relative z-10 flex flex-col items-center text-center md:items-start md:text-left py-6 md:py-12 shrink-0">
                ...
                <div className="w-full md:w-auto">
                  <div className="flex flex-col items-center md:items-start">
                    <Button onClick={scrollToContact} className="w-full md:w-auto px-8 py-3 shadow-lg shadow-red-600/20 justify-center whitespace-nowrap mb-4">
